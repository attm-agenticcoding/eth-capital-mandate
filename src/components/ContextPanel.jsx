    ...
    <section className="panel">
      ...
      <div className="context-grid">
        ...
        <div className="ctx-card">
          ...
          <p className="bear-note">⚠ Pair with take-rate (Bear panel): high share ≠ L1 revenue. Ethereum hosts {st.ethSharePct}% of stablecoin supply yet captures ≈0% take.</p>
        </div>

        <div className="ctx-card">
          <div className="ctx-h">RWA value by chain <span className="muted">{fmtUsd(rwa.totalUsd)} total</span></div>
          <ShareList rows={rwa.byChain || []} />
          <p className="bear-note">Ethereum-system share of tokenized real-world assets: {rwa.ethSharePct}%.</p>
        </div>
